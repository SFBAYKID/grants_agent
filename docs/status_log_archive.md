# Grant status log — archive (2026-08-06 and earlier)

Split from `docs/status_log.md` on 2026-08-11 at the 1000-line cap (Constitution rule 4), oldest first, exactly as that file's own pointer said it
would need to be. Nothing is retired: several entries here correct an earlier
claim that turned out to be false, which is the history most worth keeping.
