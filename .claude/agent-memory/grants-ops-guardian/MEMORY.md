...
- [Deploy b4a8046 reminders+email (CURRENT PROD)](deploy-b4a8046-reminders-email.md) — LIVE 2026-08-09 schema 32→35, PID 22742, 6th cron line; an unquoted spaced `.env` value BREAKS `source .env` and aborts it at that line
