...
- [Tenant .env ops + baselines](env-zoominfo-20260809.md) — CURRENT .env f4abd546…/66 lines/32 keys after Stage 2; append recipe (check last byte, prove prefix sha); crontab 575fbc7c…, PID 1227; pgrep -f self-matches over ssh
...
- [Deploy 26153bd DROP_AFTER 14d (CURRENT PROD)](deploy-26153bd-drop-after-14d.md) — LIVE 2026-08-09, schema 32, PID 19225; 14d still does NOT reach the playground (newest subject 22d old); nudge NOT fired; `--execute` permanently burns every suppressed subject it walks past
