...
# Field-selection and evidence rules moved to `salesforce_contact_fields` at the
# 1000-line cap; re-exported here because several modules and tests import them
# from this module by name.
from .salesforce_contact_fields import (  # noqa: E402
    LEAD_RECORD_TYPE as LEAD_RECORD_TYPE,
    _USABLE_CONTACT_STATUSES as _USABLE_CONTACT_STATUSES,
    _contact_evidence as _contact_evidence,
    _grant_headline as _grant_headline,
    _infer_industry as _infer_industry,
    _lead_value as _lead_value,
    _row_value as _row_value,
    choose_email as choose_email,
    choose_phone as choose_phone,
    email_is_general as email_is_general,
    grant_summary as grant_summary,
    organization_fields as organization_fields,
    split_person_name as split_person_name,
    title_is_writable as title_is_writable,
)
...
def contact_lead_payload(
    ...
    if title_is_writable(contact, entity):
